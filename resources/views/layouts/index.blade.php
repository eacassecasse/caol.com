    ...
    <div class="row">
        <div class="col-12 my-2 py-4 container">
            <form class="needs-validation" id="search">
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="btn-group" role="group" id="group-selector" aria-label="Basic radio toggle button group">
                            <input type="radio" class="btn-check" name="btnOptions" id="btnConsultores" value="consultores" autocomplete="off"
                            ...
                            <input type="radio" class="btn-check" name="btnOptions" id="btnClientes" value="clientes" autocomplete="off"
                ...
                <div class="form-group row" id="consultor-group">
                    ...
                    <div class="col-12 col-lg-4 px-3 pe-4 ps-lg-0">
                        <select class="form-control select-picker custom-select
                        @error('consultores')
                            is-invalid
                        @enderror" name="consultores[]" id="consultores"
                            multiple>
                ...
                <div class="form-group row d-none" id="cliente-group">
                    ...
                    <div class="col-12 col-lg-4 px-3 pe-4 ps-lg-0">
                        ...
                        @error('clientes')
                            is-invalid
                        @enderror" name="clientes[]" id="clientes" multiple>
                ...
                <div class="btn-group btn-group-toggle">
                    <button class="btn btn-outline-primary" type="submit" name="submitButton"
                        value="report">Relat&oacute;rio</button>
                    <button class="btn btn-outline-primary" type="submit" name="submitButton"
                        value="barChart">Gr&aacute;fico</button>
                    <button class="btn btn-outline-primary" type="submit" name="submitButton"
                        value="pieChart">Pizza</button>
                </div>
