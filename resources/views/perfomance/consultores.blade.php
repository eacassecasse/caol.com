    ...
    <div class="row">
        <div class="col-12 py-1">
            <div class="btn-group" role="group" aria-label="Outlined Radio Options">
                <input type="radio" name="btnOptions" class="btn-check" id="btnConsultores" autocomplete="off" checked>
                <label class="btn btn-outline-secondary" for="btnConsultores">Consultores</label>

                <input type="radio" name="btnOptions" class="btn-check" id="btnClientes" autocomplete="off">
            ...
            <div class="row">
                <div class="col-auto">
                    <label class="form-label" for="selectorUsuarios">
                        <strong class="strong">Consultores</strong>
                    </label>
                </div>
